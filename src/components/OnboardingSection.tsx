...
const FEATURES = [
  ...
  },
  {
    title: "자금 부족 경고",
    description:
      "예상 최저 잔액과 자금 부족 기간, 필요한 현금 버퍼를 확인할 수 있습니다.",
  },
  {
    title: "시나리오 비교",
    description:
      "보수·기준·낙관 시나리오를 바꿔보며 현금흐름 범위를 비교할 수 있습니다.",
  },
] as const;
    ...
    >
      <div className="max-w-3xl">
        ...
        <p className="mt-3 text-sm leading-7 text-slate-600 sm:text-base">
          통장 거래내역 Excel을 업로드하면 최근 입출금 패턴을 분석하고
          향후 3개월의 예상 잔액, 자금 부족 가능성과 필요한 현금 버퍼를
          자동으로 계산합니다.
        </p>
      </div>
